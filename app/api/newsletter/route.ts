...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { error: emailError } = await resend.emails.send({
      from: 'Select de What Else by Vinc <bonjour@whatelsebyvinc.com>', // Nécessite un domaine vérifié sur Resend, ou onboarding@resend.dev pour les tests
      to: [email],
      subject: 'Bienvenue sur Select de What Else by Vinc !',
