...
import { categories, getArticlesByCategoryName, getCategoryBySlug } from '@/lib/content'
              ...
              {categoryArticles.map((article) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <h2 className="mt-2 font-serif text-lg font-semibold leading-snug text-card-foreground group-hover:text-primary">
                      {article.title}
                    </h2>
